...
###############
window = tk.Tk()
window.title("iCatch - iOS Cache Analysis for Tracking Coordinates History, v1.1")
...
def show_about():
    ...
    4.	Select radius filter to limit the maximum radius of horizontial accuracy.
    ...
    *************
    ...
    For more informaiton about this, including speed artifacts, check ou the amazing work by
    Scott Koenig at:
